...
int main(){
    const int Largura = 1366, Altura = 768;
    //const int Largura = GetMonitorWidth(0), Altura = GetMonitorHeight(0);
    ...
    //area dos sprites
    Texture fundo_mapa1, sprite_personagem, sprite_baronesa, sprite_diario, sprite_lamp, sprite_lamp_fire, sprite_oil, sprite_dica_p1, sprite_geladeira;
    ...
    sprite_dica_p1 = LoadTexture("./sprites/dica_1_atualizado.png");
